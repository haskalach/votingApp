...
@Component({
  selector: 'app-reference-voter-view',
  templateUrl: './reference-voter-view.component.html',
  styleUrls: ['./reference-voter-view.component.scss']
})
export class ReferenceVoterViewComponent implements OnInit {
